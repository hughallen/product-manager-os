...
**Usage:** Use `@pm-toolkit/6-delivery/generate-tasks.mdc` to create tasks from your PRD.

**Processing:** Use `@pm-toolkit/6-delivery/process-task-list.mdc` to work through tasks systematically.
...
### 1. Task Generation
- Use PRD as input for `@pm-toolkit/6-delivery/generate-tasks.mdc`
- Break down into small, manageable tasks
- Estimate effort and dependencies

### 2. Task Processing
- Use `@pm-toolkit/6-delivery/process-task-list.mdc` for systematic execution
